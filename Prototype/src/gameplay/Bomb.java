...
public class Bomb implements Runnable {
	...
	public void explode() {
		...
		if (scoreForEachEnemyKilledWithThisBomb.size() == 1) {
			pointsScoredWithThisBomb = scoreForEachEnemyKilledWithThisBomb.get(0);
		} 
			...
			if (temp < scoreForEachEnemyKilledWithThisBomb.get(1)) {
				pointsScoredWithThisBomb = temp * 2 + scoreForEachEnemyKilledWithThisBomb.get(1);
			} 
			else {
				pointsScoredWithThisBomb = temp + 2 * scoreForEachEnemyKilledWithThisBomb.get(1);
			}
			...
			for (int i = 0; i < scoreForEachEnemyKilledWithThisBomb.size(); i++) {
				int temp = (int) ((int) scoreForEachEnemyKilledWithThisBomb.get(i) * Math.pow(2, i));
