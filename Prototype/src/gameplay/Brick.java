...
public class Brick implements Serializable {
	...
	/**
	 * Constructor for bricks which calls the placeBricks method, which places
	 * bricks randomly on the grid, and loads the images.
	 * 
	 * @param grid
	 *            The grid on which we want to place the bricks.
	 */
