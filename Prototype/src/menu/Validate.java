...
public class Validate {
	...
	} // create identical method without input as getters
	...
	public boolean isPasswordValid(String password) {
		 ...
		 */
		if (((password.length() >= 8) && password.matches("[0-9a-zA-Z]{8,}")) && ((hasNumber.find() && hasLetterLowerCase.find()) && hasLetterUpperCase.find())) {
			passwordValid = true;
			return true;
		}
		return false;
